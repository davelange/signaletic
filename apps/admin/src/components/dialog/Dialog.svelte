...
>
  <Dialog.Portal>
    ...
    <Dialog.Content
      class="bg-background fixed left-[50%] top-[50%] z-50 grid max-h-[94vh] w-fit min-w-[600px] max-w-[94%] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-scroll border p-6 shadow-lg sm:rounded-lg"
    >
